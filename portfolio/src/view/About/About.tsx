      ...
      <div className="w-full md:w-[90%] h-[90%] flex flex-col md:flex-row mt-10">
        ...
        <div className="w-full md:w-2/3 md:h-[500px]  flex flex-col justify-center items-center p-5">
          ...
          <p className="font-parrafo text-[#77530a] text-base lg:text-2xl text-center md:text-justify mt-4">
            ...
            entre otras. Ofrezco soluciones digitales completas y atractivas que
            impulsan el éxito del proyecto. Soy{" "}
            <span className="text-[#77530a] font-bold">
              colaborativa, comunicativa y comprometida
            </span>{" "}
            con la calidad. Mantengo mi conocimiento actualizado con las últimas
            tendencias y tecnologías en desarrollo web.
          </p>
